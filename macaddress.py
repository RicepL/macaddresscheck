while 0==0: #loop program
    ...
    inmacad = input ("what is the mac beggining of the mac address? (00:00:00)") #where the beggining of the address will be input
    temp=1
    x=0
    while x==0:
    ...
    venlist.close()#enable you to try another mac adress after it give you the answer for the first (without it will start from previous line)
